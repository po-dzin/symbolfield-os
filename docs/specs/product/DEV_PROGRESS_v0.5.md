...
## UI_UX_BASELINE_METRICS (docs/specs/ui/foundation/UI_UX_BASELINE_METRICS_SoT_v0.5.md)
...
## UI_INTERACTION_PIPELINE (docs/specs/ui/interaction/UI_INTERACTION_PIPELINE_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## UI_HOTKEYS_SELECTION (docs/specs/ui/interaction/UI_HOTKEYS_SELECTION_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## UI_GROUPING_HUB_REGIONS (docs/specs/ui/interaction/UI_GROUPING_HUB_REGIONS_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
| Regions can be created/edited/deleted and don’t block node interaction | ✓ |  |  | `src/components/Canvas/CanvasView.tsx`, `src/components/Context/ContextToolbar.tsx`, `src/core/interaction/GestureRouter.ts` |

## UI_SPACE_FIELD_SHELL (docs/specs/ui/shells/UI_SPACE_FIELD_SHELL_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## UI_HOME_PORTAL (docs/specs/ui/shells/UI_HOME_PORTAL_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## UI_GLOBAL_GRAPH_OVERVIEW (docs/specs/ui/shells/UI_GLOBAL_GRAPH_OVERVIEW_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## UI_CONTEXT_UI (docs/specs/ui/panels/UI_CONTEXT_UI_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## UI_STATECORE (docs/specs/ui/panels/UI_STATECORE_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## UI_STATION_PANELS (docs/specs/ui/panels/UI_STATION_PANELS_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## SETTINGS_PRESETS_CUSTOMIZATION (docs/specs/ui/panels/SETTINGS_PRESETS_CUSTOMIZATION_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## UI_NAVIGATION_FLOW_STATION_FIELD_NOW (docs/specs/ui/flows/UI_NAVIGATION_FLOW_STATION_FIELD_NOW_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## UI_PORTAL_HIGHLIGHTING (docs/specs/ui/flows/UI_PORTAL_HIGHLIGHTING_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
| Hover and keyboard preview highlight target without lag |  |  | ✓ | — |
| Preview card appears only when useful |  |  | ✓ | — |

## UI_PORTAL_TRANSITIONS_ANIMATION (docs/specs/ui/flows/UI_PORTAL_TRANSITIONS_ANIMATION_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## UI_RECENT_PORTALS_TEMPLATES (docs/specs/ui/flows/UI_RECENT_PORTALS_TEMPLATES_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## SHARE_SUBGRAPH (docs/specs/growth/SHARE_SUBGRAPH_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## RITUAL_XP_LOOP (docs/specs/growth/RITUAL_XP_LOOP_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## BILLING_ENTITLEMENTS (docs/specs/growth/BILLING_ENTITLEMENTS_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
...
## HARMONY_ENGINE (docs/specs/optional/HARMONY_ENGINE_SoT_v0.5.md)
| Item | Реализовано | Частично | Нет | Доказательство |
|---|---|---|---|---|
