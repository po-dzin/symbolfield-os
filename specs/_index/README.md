...
## Source of Truth (SoT)
- Canonical specs live under `specs/`.
...
## Archive Policy
- Old (legacy v0.4) or renamed specs live in `specs/archive/`.
- No deletions: superseded files stay archived for history.

## Change Management
- Add new SoT files with canonical names.
- Update `specs/_index/SF_SPEC_INDEX_v0.5.md` after any change.
- Record migrations or renames in `specs/_index/SF_SPEC_CHANGELOG.md`.
