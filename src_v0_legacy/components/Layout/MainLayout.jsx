...
import ChronoCore from '../NOW/ChronoCore'; // Import ChronoCore
import '../NOW/ChronoCore.css'; // Import ChronoCore CSS
...
import { LAYERS } from '../../engine/layers'; // Import layer constants
    ...
    return (
        ...
        >
            ...
            */}
            ...
            {activeTab === 'now' ? (
                <div
                    className="absolute inset-0 z-[100] bg-[#050505]"
                    style={{ left: `${isNavCollapsed ? 72 : navRailWidth}px` }}
                >
                    <NOWView />
                </div>
            ) : (
            ...
            <div className="absolute inset-0 pointer-events-none" style={{ zIndex: LAYERS.TRINITY_OVERLAY }}>
                {(() => {
                    ...
                    if (activeTab === 'now') {
                        return (
                            <div
                                ...
                                style={{ zIndex: LAYERS.CHRONO_CORE, top: '84px', right: '20px' }}
                            >
                                <ChronoCore />
                            </div>
                        );
