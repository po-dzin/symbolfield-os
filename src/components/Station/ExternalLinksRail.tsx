            ...
            {sortedLinks.map(link => (
                <div key={link.id} className="relative group/link">
                    <button
                        ...
                        className="ui-selectable group flex items-center gap-3 w-full text-left rounded-[6px] px-2 py-1.5 transition-all mx-1 w-[calc(100%-8px)]"
                    ...
                    <button
                        ...
                        className="absolute right-2 top-1/2 -translate-y-1/2 text-[10px] text-[var(--semantic-color-text-muted)] hover:text-[var(--semantic-color-status-error)] transition-colors opacity-0 group-hover/link:opacity-100"
